 ...
 * @Description:
 * @Author: Axin
 * @Date: Create in 16:28 2019/8/25
 */
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        boolean tableExist = Main.isTableExist("student");
        ...
        //addRowData("staff",
        //                "3","info1","name","zhangsan");

        //deleteMultiRow("staff","1");
        //getAllRows("staff");
        //getRow("staff","2");
        getRowQualifier("staff","2","info1","name");
